...
from fixtures.neon_fixtures import NeonEnv, PortDistributor, Postgres, NeonEnvBuilder, Etcd, NeonPageserverHttpClient, assert_no_in_progress_downloads_for_tenant, assert_timeline_local, wait_until, wait_for_last_record_lsn, wait_for_upload, neon_binpath, pg_distrib_dir
...
def test_tenant_relocation(neon_env_builder: NeonEnvBuilder,
    ...
    with new_pageserver_helper(new_pageserver_dir,
        ...
        wait_until(
            ...
            interval=1,
            func=lambda: assert_no_in_progress_downloads_for_tenant(new_pageserver_http, tenant_id))
